...
urlpatterns = [
    ...
    path('vote/request-otp/', views.request_email_otp, name='request_email_otp'),
    path('vote/verify/', views.verify_email_otp, name='verify_email_otp'),
    path('dashboard/election-summary.json', views.election_summary_json, name='election_summary_json'),
    path('vote/<int:election_id>/export.csv', views.export_results_csv, name='export_results_csv'),
    ...
    path('profile/update', views.change_profile, name="update_profile"),
    ...
    path('admin_dashboard/regional-content/', views.regional_content_dashboard, name='regional_content_dashboard'),
    path('admin_dashboard/regional-content/posts/add/', views.regional_post_create, name='regional_post_add'),
    path('admin_dashboard/regional-content/posts/<int:post_id>/edit/', views.regional_post_edit, name='regional_post_edit'),
    path('admin_dashboard/regional-content/posts/<int:post_id>/delete/', views.regional_post_delete, name='regional_post_delete'),
    path('admin_dashboard/regional-content/videos/add/', views.regional_video_create, name='regional_video_add'),
    path('admin_dashboard/regional-content/videos/<int:video_id>/edit/', views.regional_video_edit, name='regional_video_edit'),
    path('admin_dashboard/regional-content/videos/<int:video_id>/delete/', views.regional_video_delete, name='regional_video_delete'),
    path('admin_dashboard/regional-content/officers/add/', views.regional_officer_create, name='regional_officer_add'),
    path('admin_dashboard/regional-content/officers/<int:officer_id>/edit/', views.regional_officer_edit, name='regional_officer_edit'),
    path('admin_dashboard/regional-content/officers/<int:officer_id>/delete/', views.regional_officer_delete, name='regional_officer_delete'),
